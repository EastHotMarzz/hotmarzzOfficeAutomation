			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li><c:if test="${roleForm.roleId == null || roleForm.roleId == ''}">
								<a id="fillingManageLink" href="roles.do">角色管理</a>
							</c:if> 
							<c:if test="${!(roleForm.roleId == null || roleForm.roleId == '')}">
								<a id="fillingManageLink" href="roles.do">角色管理</a>
							</c:if></li>
						<li class="active">
							<c:if
								test="${roleForm.roleId == null || roleForm.roleId == ''}">
												角色添加
							</c:if> 
							<c:if
								test="${!(roleForm.roleId == null || roleForm.roleId == '')}">
											...
											<div class="step-content pos-rel">
												<div class="step-pane active" data-step="1">
													<form:form cssClass="form-horizontal" id="fillForm"
														...
														<c:if
															test="${!(roleForm.roleId == null || roleForm.roleId == '')}">
															<form:hidden path="roleId" cssClass="col-xs-12 col-sm-6" />
														</c:if>

														<div class="form-group">
															<form:label path="roleName"
																cssClass="control-label col-xs-12 col-sm-3 no-padding-right">角色姓名:</form:label>
														...
														<div class="form-group">
															<form:label path="remark"
																cssClass="control-label col-xs-12 col-sm-3 no-padding-right">角色描述:</form:label>
															<div class="col-xs-12 col-sm-9">
																<div class="clearfix">
...
<![endif]-->
			...
			<script type="text/javascript">
				jQuery(function($) {
					...
					var listUrl = "roles.do";
					var addOrUpdateUrl = "role.do";
					...
					$("#submitBtn")
							.on("click",
									function(e) {
										...
										var update = $("#fillForm input[name='roleId'][type='hidden']").length > 0;
										var method = "post";
										if (update) {
											method = "put";
										}
