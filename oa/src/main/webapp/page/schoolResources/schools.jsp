		...
		<div class="main-content-inner">
			...
			<div class="page-content">
				...
				<div class="page-header">
					<h1>
						教务管理 <small> <i class="ace-icon fa fa-angle-double-right"></i>
							校区管理
						</small>
					</h1>
				</div>
						...
						<div class="widget-box">
							<div class="widget-header widget-header-flat widget-header-small">
								<h5 class="widget-title">
									<i class="ace-icon fa fa-search"></i> 校区管理
								</h5>
								...
								<div class="widget-main">
									<form:form id="searchForm"
										...
										<div class="form-group">
											<form:label path="queryParams[schoolName]"
												cssClass="col-sm-1 control-label no-padding-right">校区名称</form:label>

											<div class="col-sm-3">
												<form:input id="form-field-1" path="queryParams[schoolName]"
													placeholder="校区名称" cssClass="col-xs-10 col-sm-5" />
											</div>
											
											<form:label path="queryParams[province]"
												cssClass="col-sm-1 control-label no-padding-right">所在省</form:label>

											<div class="col-sm-3">
												<form:input id="form-field-1" path="queryParams[province]"
													placeholder="所在省" cssClass="col-xs-10 col-sm-5" />
											</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="widget-box">
							<div class="widget-header widget-header-flat widget-header-small">
								<h5 class="widget-title">
									<i class="ace-icon fa fa-database"></i> 校区信息
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			var preParams = function() {
				...
				if($(":input[name='queryParams[schoolName]']")!=null&&$(":input[name='queryParams[schoolName]']")!=undefined){
					bq.queryParams.schoolName = $(":input[name='queryParams[schoolName]']").val();
				}
				if($(":input[name='queryParams[province]']")!=null&&$(":input[name='queryParams[province]']")!=undefined){
					bq.queryParams.province = $(
					":input[name='queryParams[province]']").val();
				}
			...
			var writeParams = function(result) {
				$(":input[name='queryParams[province]']").val(
						result.queryParams.province);
				$(":input[name='queryParams[schoolName]']").val(
						result.queryParams.schoolName);
			...
			var tableColumn = [
					...
					},
					{
						...
						data : function( row, type, val, meta ) {
							var id = row['schoolId'];
							var str = "<a class='update blue' href='school/"+id+".do' data-toggle='modal'>修改</a>"
									+ "&nbsp;&nbsp;"
									+ "<a class='dele red' href='school/"+id+".do' data-toggle='modal'>删除</a>";
